$(document).ready(function () {
    if (typeof modal_error !== 'undefined' && modal_error) {
        $('.modal .modal-title').html(modal_title);
        $('.modal .modal-body').html(modal_error_view);
        //$('.modal .modal-body').html(decodeURIComponent(escape(unescape(modal_error_view))));
        $('.modal').modal('show');
    }
